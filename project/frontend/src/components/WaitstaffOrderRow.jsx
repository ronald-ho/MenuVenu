...
function WaitstaffOrderRow ({ orderItem, setOrderItemsToServe, tables }) {
    ...
    return (
        <>
            <TableRow>
                ...
                <TableCell>{tables.find(obj => {return obj.table_id == orderItem.table_number})["table_number"]}</TableCell>
                <TableCell>
