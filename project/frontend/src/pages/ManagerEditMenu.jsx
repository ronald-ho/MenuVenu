  ...
  return (
    ...
    >
                ...
                <Box sx={{
                  ...
                  <Box sx={{
                    ...
                    <Alert severity='info' aria-label='infoAlert'
                      ...
                      To get started with building your menu, click the button below to add your
                      first category.
                    </Alert>
                  </Box>
                  <BouncingArrow/>
                  ...
                  {(provided) => (
                    ...
                    >
                      {categories && categories.map((category, index) => (
                        <Draggable key={category.category_id}
                          draggableId={category.category_id.toString()} index={index}>
                          {(provided) => (
                            <div
      ...
      >
        <Box sx={{
          borderRight: '1px solid #caccce',
          borderTop: '1px solid #caccce',
          width: 1 / 3
        }}>
          <Button onClick={() => setOpenAddCategory(true)} sx={{ margin: '12.5px' }} color='success'
            variant='outlined'>
            <Add/> New Category
          </Button>
        </Box>
      ...
      {openAddCategory &&
        <AddCategoryPopUp open={openAddCategory} setOpen={setOpenAddCategory} setCategories={setCategories}/>}
