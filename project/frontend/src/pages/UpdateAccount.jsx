...
import { getProfile } from '../helpers/loaderfunctions';
  ...
  return (
    <>
      ...
      <div style={{ textAlign: 'center' }}>
        ...
        <Typography sx={{ marginBottom: '20px' }}>Google
          Fit: {isSignedIn ? 'Connected' : 'Unconnected'}</Typography>
        <Box sx={{
          display: 'inline-flex',
          justifyContent: 'center',
          gap: '30px'
        }}>
          <Button component={Link} to={'/changedetails'} variant='contained' size='large'
            sx={{ width: '300px' }}>
            <Update sx={{
              mr: 1,
              fontSize: 30
          ...
          <Button onClick={() => client.requestAccessToken()} component={Link} variant='contained'
            size='large' sx={{ width: '300px' }}>
            {isSignedIn
              ? (
          ...
          <Button component={Link} to={'/deleteaccount'} variant='contained' size='large'
            sx={{ width: '300px' }}>
            <Delete sx={{
              mr: 1,
              fontSize: 30
